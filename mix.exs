defmodule NervesSystemRpi4MqttDb.MixProject do
  use Mix.Project

  @app :nerves_system_rpi4_mqtt_db
  ...
  defp nerves_package do
    [
      type: :system,
      artifact_sites: [
        {:github_releases, "ripple0328/#{@app}"}
      ],
  ...
  defp package do
    [
      files: package_files(),
      licenses: ["Apache 2.0"],
      links: %{"GitHub" => "https://github.com/ripple0328/#{@app}"}
    ]
  end
